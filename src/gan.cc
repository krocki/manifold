...
* @Last Modified time: 2017-04-20 19:12:52
*/
...
int compute() {
	...
	discriminator = std::shared_ptr<NN> ( new NN ( batch_size, decay, learning_rate, MLP, {input_width, 100, 1}, RELU, false ) );
	encoder = std::shared_ptr<NN> ( new NN ( batch_size, decay, learning_rate, MLP, {input_width, 100 }, RELU, false ) );
