...
* @Last Modified time: 2017-03-30 19:46:03
*/
...
int compute() {
	...
	nn = std::shared_ptr<NN> ( new NN ( batch_size, decay, AE, {image_size * image_size, 16, 16, 16, 16, 16, 3, 16, 16, 16, 16, 16, image_size * image_size} ) );
