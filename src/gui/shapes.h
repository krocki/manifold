...
* @Last Modified time: 2017-03-17 19:02:10
*/
...
void drawbox ( Eigen::MatrixXf &boxline_positions, Eigen::MatrixXf &boxline_colors, size_t &m_boxlineCount,
	...
	//crosshair
	boxline_positions.col ( 26 ) << pos[0] + cursor_x, pos[1] + cursor_y, pos[2] - r[2] + 0.0001f;
	boxline_positions.col ( 27 ) << pos[0] + cursor_x, pos[1] + cursor_y, pos[2] + r[2] - 0.0001f;
	
	boxline_positions.col ( 28 ) << pos[0] + cursor_x - 0.001f, pos[1] + cursor_y, pos[2] - r[2] + 0.0001f;
	boxline_positions.col ( 29 ) << pos[0] + cursor_x + 0.001f, pos[1] + cursor_y, pos[2] - r[2] + 0.0001f;
	boxline_positions.col ( 30 ) << pos[0] + cursor_x, pos[1] + cursor_y - 0.001f, pos[2] - r[2] - 0.0001f;
	boxline_positions.col ( 31 ) << pos[0] + cursor_x, pos[1] + cursor_y + 0.001f, pos[2] - r[2] - 0.0001f;
