...
class GUI : public nanogui::Screen {
	...
	public:
		...
		void makeWidgets() {
			...
			plot_data->icons = nanogui::loadImageDirectory ( mNVGContext, "saved/gan" );
			...
			imgPanel->setCallback ( [this, imgPanel] ( int i ) {
				...
				nanogui::Serializer e ( std::string ( "e_" + fprefix + ".nn.bin" ).c_str(), false );
				nn->load ( g );
		...
		nanogui::Graph *graph_loss, *graph_fake_acc, *graph_real_acc, *graph_encoder_loss, *graph_generator_w_norm, *graph_discriminator_w_norm, *graph_generator_dw_norm, *graph_discriminator_dw_norm,
				*graph_generator_mw_norm, *graph_discriminator_mw_norm;
