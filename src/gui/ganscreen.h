...
class GUI : public nanogui::Screen {
	...
	public:
		...
		void makeWidgets() {
			...
			graph_loss->values().resize ( 10000 );
			graph_loss->setFixedSize ( {DEF_WIDTH - 50, 40} );
			...
			graph_fake_acc->values().resize ( 10000 );
			graph_fake_acc->setFixedSize ( {DEF_WIDTH - 50, 40} );
			...
			graph_real_acc->values().resize ( 10000 );
			graph_real_acc->setFixedSize ( {DEF_WIDTH - 50, 40} );
			...
			graph_cpu->values().resize ( 10000 );
			graph_cpu->setFixedSize ( {DEF_WIDTH - 50, 40} );
			...
			graph_flops->values().resize ( 10000 );
			graph_flops->setFixedSize ( {DEF_WIDTH - 50, 40} );
			...
			graph_bytes->values().resize ( 10000 );
			graph_bytes->setFixedSize ( {DEF_WIDTH - 50, 40} );
