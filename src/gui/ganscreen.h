...
class GUI : public nanogui::Screen {
  ...
  public:
	...
	void makeWidgets() {
		...
		window->setPosition ( Eigen::Vector2i ( COL2X + 280, 350 ) );
		...
		texButtons->setPosition ( {COL2X, 350} );
		texWindow->setPosition ( {COL2X, 410} );
		texWindowRight->setPosition ( {COL2X + 295, 610} );
	...
	nanogui::Graph *graph_loss, *graph_fake_acc, *graph_real_acc, *graph_encoder_loss, *graph_generator_w_norm, *graph_discriminator_w_norm, *graph_generator_dw_norm, *graph_discriminator_dw_norm, *graph_generator_mw_norm, *graph_discriminator_mw_norm;
