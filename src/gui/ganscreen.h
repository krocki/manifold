...
class GUI : public nanogui::Screen {
  ...
  public:
	...
	nanogui::Graph *graph_loss, *graph_fake_acc, *graph_real_acc, *graph_encoder_loss, *graph_generator_w_norm, *graph_discriminator_w_norm, *graph_generator_dw_norm, *graph_discriminator_dw_norm, *graph_generator_mw_norm, *graph_discriminator_mw_norm, *graph_generator_dx_norm, *graph_generator_dy_norm, *graph_discriminator_dx_norm, *graph_discriminator_dy_norm;
