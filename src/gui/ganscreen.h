...
class GUI : public nanogui::Screen {
  ...
  public:
	...
	void makeWidgets() {
		...
		window->setPosition ( Eigen::Vector2i ( COL2X + 280, 250 ) );
		...
		texButtons->setPosition({COL2X, 250});
		texWindow->setPosition({COL2X, 310});
		texWindowRight->setPosition({COL2X + 295, 510});
		...
		Eigen::Vector2i graph_size = Eigen::Vector2i({COL2W, 30});
