...
class GUI : public nanogui::Screen {
  ...
  public:
	...
	virtual bool resizeEvent ( const Eigen::Vector2i & size ) {
		...
		window->setPosition(Eigen::Vector2i(5, size[0] / 3 + 12));
		graphs->setPosition(Eigen::Vector2i(size[0] - 220, size[0] / 3 + 12));
		texButtons->setPosition(Eigen::Vector2i(window->size()[0] + 20, size[0] / 3 + 12));
		texWindow->setPosition(Eigen::Vector2i(window->size()[0] + 20, size[0] / 3 + 63));
		texWindowRight->setPosition(Eigen::Vector2i(window->size()[0] + 300, size[0] / 3 + 12));
	...
	void makeWidgets() {
		...
		b->setFlags(nanogui::Button::RadioButton); b->setFixedSize(bsize); b->setBackgroundColor(ccolor); b->setPushed(true);
		b->setCallback([&]() { std::cout << "SGD: " << std::endl; nn->otype = SGD;});

		b = opt_buttons->add<nanogui::Button>("AD0"); b->setFontSize(8);
		b->setFlags(nanogui::Button::RadioButton); b->setFixedSize(bsize); b->setPushed(false); b->setBackgroundColor(ccolor);
		...
		b->setFlags(nanogui::Button::RadioButton); b->setFixedSize(bsize); b->setPushed(mCurrentTex == idx++); b->setBackgroundColor(ccolor);
		...
		b->setFlags(nanogui::Button::RadioButton); b->setFixedSize(bsize); b->setBackgroundColor(ccolor); b->setPushed(mCurrentTex == idx++);
